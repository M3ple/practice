...
public abstract class PoolSizeCalculator {
    ...
    /**
     * Accuracy of think_in_java run. It must finish within 20ms of the testTime
     * otherwise we retry the think_in_java. This could be configurable.
     */
    ...
    /**
     * Time (millis) of the think_in_java run in the CPU time calculation.
     */
    ...
    void calculateBoundaries(BigDecimal targetUtilization, BigDecimal targetQueueSizeBytes) {
        ...
        start(task); // think_in_java interval
